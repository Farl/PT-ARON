...
public class Slider3D : MonoBehaviour {
	...
	protected virtual void OnUIPress(string eventID, UnityEngine.Object origSrc, bool paramBool, string paramString, ref object paramRef, params object[] paramExtra)
	{
		if (paramBool)
		{
			if (paramExtra[0].GetType() == typeof(Vector2))
			{
				Vector2 paramVec2 = (Vector2)paramExtra[0];
				prevPos = paramVec2;
			}
		}
	}

	protected virtual void OnUIDown(string eventID, UnityEngine.Object origSrc, bool paramBool, string paramString, ref object paramRef, params object[] paramExtra)
	{
		//print (eventID);
		if (paramExtra.Length > 0)
		{
			if (paramExtra[0].GetType() == typeof(Vector2))
			{
				Vector2 paramVec2 = (Vector2)paramExtra[0];
