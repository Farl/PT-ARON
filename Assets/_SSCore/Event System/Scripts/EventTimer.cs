...
{	
	public class EventTimer : MonoBehaviour
	{
		...
		IEnumerator Broadcast(BroadcastInfo bi)
		{
			...
			{
				// Object Event
				EventManager.SendObjectEvent(bi.em.targetObj, bi.em.eventID, bi.em.origSrc, bi.em.paramBool, bi.em.paramString, ref refObj, bi.em.paramExtra, Vector2.zero);
			}
			else
			{
				// Global Event
				EventManager.Broadcast(bi.em.eventID, bi.em.origSrc, bi.em.paramBool, bi.em.paramString, ref refObj, bi.em.paramExtra, Vector2.zero);
			}
